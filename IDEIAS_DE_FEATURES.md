...
7→- [ ] Tema claro/escuro com toggle fixo no header usando o theming do Chakra UI.
8→- [x] Animações de transição entre páginas (React Router) com framer-motion.

- [ ] Estados de loading mais ricos (skeletons, shimmer) em todas as listas e banners.
